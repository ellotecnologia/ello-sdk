...
def ignore_line(text):
    ...
    technical_terms.append('refator(a|ei|ado|ada|ação)')
    technical_terms.append('compil(ar|ado|ando|ação|acao)')
    technical_terms.append('c.digo fonte')
    technical_terms.append('desacopl(ando|ado)*')
    technical_terms.append('removi(do|da)* (m.todo|rotina|atributo|propriedade)')
    technical_terms.append('renome(ia|ado|ada|ei) vari.vel')
