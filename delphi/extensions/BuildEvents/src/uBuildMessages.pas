...
type
  TBuildEventMessage = Class(TInterfacedObject, IOTACustomMessage, INTACustomDrawMessage)
  private
    FMsg : String;
    FFontName   : String;
    FForeColour : TColor;
  ...
  protected
    function CalcRect(ACanvas: TCanvas; AMaxWidth: Integer; AWrap: Boolean): TRect;
  ...
  public
    constructor Create(AMsg: String; AFontName: String; AForeColour: TColor = clBlack; AStyle: TFontStyles = []; ABackColour: TColor = clWindow);
...
{ TBuildEventMessage }
constructor TBuildEventMessage.Create(AMsg, AFontName: String; AForeColour: TColor; AStyle: TFontStyles; ABackColour: TColor);
var
  i : Integer;
  iLength : Integer;
begin
...
function TBuildEventMessage.CalcRect(ACanvas: TCanvas; AMaxWidth: Integer; AWrap: Boolean): TRect;
begin
...
procedure TBuildEventMessage.Draw(ACanvas: TCanvas; const ARect: TRect; AWrap: Boolean);
begin
